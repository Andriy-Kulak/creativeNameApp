/* jshint strict: true */
/* jshint jasmine: true */
define(["require", "exports", 'components/services/creative.service'], function (require, exports, CreativeService) {
    "use strict";
    describe('Creative Service', function () {
        ...
        it("should get list of Creative Ops options", function () {
        ...
        it("should be able to get a list of available lob options", function () {
        ...
        it("should be able to get a list of available Intended Screens", function () {
        ...
        it("should be able to get a list of available Products", function () {
            httpBackend.whenGET("/api/lobs").respond([
        ...
        it("should be able to get a list of available Creative Categories", function () {
            httpBackend.whenGET("/api/lobs").respond([
        ...
        it("should be able to get a list of available Video Lengths", function () {
        ...
        it("should be able to get a list of available A/B Test Labels", function () {
        ...
        it("should be able to get a list of available Creative Ops", function () {
            httpBackend.whenGET("/api/creativeops").respond([
        ...
        it("should be able to get a list of available Creative Types", function () {
...
//# sourceMappingURL=creative.service.spec.js.map