    ...
    describe('Index controller', function () {
        ...
        beforeEach(angular.mock.module('creative.module'));
            ...
            it("has a clearAllFunction method that should create a new instance of model to delete current values from current inputs", () => {
                // setting up values that will trigger a dirty/touched form
                controller.nameConvForm = {
                    $valid: true,
                    $setPristine: function (): void { },
                    $setUntouched: function (): void { },
                }
            ...
            it("has a addNameConv method that should PREVENT a postCreativeName method execution when form IS *IN*VALID", () => {
            ...
            it("has a addNameConv method that should send a postCreativeName method when form IS VALID", () => {
                //// setting up values for form
