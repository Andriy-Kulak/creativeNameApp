define(["require", "exports"], function (require, exports) {
    "use strict";
    var ExistingCtrl = (function () {
        function ExistingCtrl($scope, CreativeDataList, $filter) {
            var vm = this;
            vm.$scope = $scope;
            ...
            vm.lobOption = CreativeDataList.map(function (obj) { return obj.lob.name; });
        ...
        ExistingCtrl.$inject = ['$scope', 'CreativeDataList', '$filter'];
        return ExistingCtrl;
    }());
    return ExistingCtrl;
});
//# sourceMappingURL=existing.controller.js.map