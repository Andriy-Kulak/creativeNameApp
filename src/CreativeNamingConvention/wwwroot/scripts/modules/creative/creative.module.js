define(["require", "exports", 'modules/creative/controllers/index.controller', 'modules/creative/controllers/existing.controller', 'components/services/creative.service', 'components/services/formModal.service', 'components/services/infoModal.service', 'components/services/1auth.factory', 'modules/auth/controllers/1auth.controller'], function (require, exports, IndexCtrl, ExistingCtrl, CreativeService, FormModalService, InfoModalService, AuthFactory, AuthController) {
    "use strict";
    var app = (function () {
        angular.module("creative.module", [
            ...
            function ($stateProvider, $urlRouterProvider, $locationProvider, $httpProvider) {
                ...
                $stateProvider
                    ...
                    .state('auth', {
                    url: '/creative/login',
                    templateUrl: 'scripts/modules/auth/views/index.html',
...
//# sourceMappingURL=creative.module.js.map